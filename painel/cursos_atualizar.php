  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Atualização de Cursos</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Atualização de Cursos</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <form id="quickForm">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="nome_curso" class="form-control" id="exampleInputEmail1" placeholder="Nome do Curso">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Período</label>
                    <input type="text" name="periodo" class="form-control" id="exampleInputPassword1" placeholder="Período">
                  </div>   
                </div>
                <!-- /.card-body -->
